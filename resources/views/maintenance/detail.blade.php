                        ...
                        <div class="row mb-2">
                            <div class="col-xl-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="serial" class="form-control" id="serial" value="{{$data->serial}}">
                                </div>
                            </div>
                            <div class="col-xl-4">
                                <div class="form-group">
                                    <label class="form-label" for="">Maintenance Date</label>
                                    <input type="date" name="maintenance_date" class="form-control" id="maintenance_date" value="{{$data->maintenance_date}}">
                                </div>
                            </div>
                            <div class="col-xl-4">
                                <div class="form-group">
